...
(function () {
  ...
  async function reloadAccountData() {
    const [staff, annFile, pending] = await Promise.all([
      fetch("/staff.json?_=" + Date.now(),            { cache: "no-store" }).then(r => r.ok ? r.json() : null).catch(() => null),
      fetch("/annotations.json?_=" + Date.now(),      { cache: "no-store" }).then(r => r.ok ? r.json() : null).catch(() => null),
      fetch("/pending-transfers.json?_=" + Date.now(),{ cache: "no-store" }).then(r => r.ok ? r.json() : null).catch(() => null),
    ]);
  ...
  /* ─── Boot ────────────────────────────────────────────────────────── */
  Promise.all([
    fetch("/people.json?_=" + Date.now(),           { cache: "no-store" }).then(r => r.ok ? r.json() : null).catch(() => null),
    fetch("/staff.json?_=" + Date.now(),            { cache: "no-store" }).then(r => r.ok ? r.json() : null).catch(() => null),
    fetch("/wall.json?_=" + Date.now(),             { cache: "no-store" }).then(r => r.ok ? r.json() : null).catch(() => null),
    ...
    fetch("/annotations.json?_=" + Date.now(),      { cache: "no-store" }).then(r => r.ok ? r.json() : null).catch(() => null),
    fetch("/admins.json?_=" + Date.now(),           { cache: "no-store" }).then(r => r.ok ? r.json() : null).catch(() => null),
    fetch("/pending-transfers.json?_=" + Date.now(),{ cache: "no-store" }).then(r => r.ok ? r.json() : null).catch(() => null),
    fetch("/payroll-data.json?_=" + Date.now(),     { cache: "no-store" }).then(r => r.ok ? r.json() : null).catch(() => null),
    fetch("/google-accounts.json?_=" + Date.now(),  { cache: "no-store" }).then(r => r.ok ? r.json() : null).catch(() => null),
    fetch("/warehouse-activity.json?_=" + Date.now(),{ cache: "no-store" }).then(r => r.ok ? r.json() : null).catch(() => null),
